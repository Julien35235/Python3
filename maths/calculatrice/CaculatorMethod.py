def openfileCalculatorMethod():
    ...
    btn_sous = tk.Button(root, text="-", command=lambda: add_to_calculation("-"), width=5, font=('Arial', 14))
    ...
    btn_clos = tk.Button(root, text=")", command=lambda: add_to_calculation(")"), width=5, font=('Arial', 14))
