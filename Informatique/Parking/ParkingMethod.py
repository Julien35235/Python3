def openfilleParkingMethod():
    ...
    villes = [
        ...
        "Bangalore", "Abidjan", "Accra", "Libreville", "Conakry", "Dakar", "Casablanca", "Madrid", "Barcelone",
        ...
        "Anchorage", "Qamani'tuaq", "Reykjavik", "Longyearbyen", "Oslo", "Stockholm", "Helsinki", "Rovaniemi",
