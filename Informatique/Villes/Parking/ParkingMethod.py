...
def openfilleParkingMethod():
    ...
    villes = [
        ...
        "Madrid", "Barcelone", "La Corogne", "Saint-Jacques-de-Compostelle",  "Anvers", "Bruxelles", "Liège", "Aix-la-Chapelle",
        "Porto", "Bilbao", "Palma", "Lisbonne", "Vigo", "Porto", "Séville", "Cadix", "Gibraltar", "Málaga", "Tunis", "Tripoli",
