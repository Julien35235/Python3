...
class TrainReservation:
    def __init__(self, compagnie_train, numero_train, gare_depart, gare_arrivee, date_depart, date_arrivee, nb_passagers):
...
def effectuer_reservation_train():
    ...
    reservation = TrainReservation(compagnie_train, numero_train, gare_depart, gare_arrivee, date_depart, date_arrivee, nb_passagers)
    reservation.afficher_details()
