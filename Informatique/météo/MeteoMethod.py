def openfilleMeteoMethod():
    ...
    "Nicosie", "Larnaca Λάρνακα","Le Caire", "Louxor الأقصر", "Edfou إدفو", "Kôm Ombo aكوم امبو", "Qena قنا", "Assouan أسوان", "Abou Simbel أبو سمبل السياحية",
    "Hurghada الغردقة", "Port Ghalib بورت غالب", "Marsa Alam مرسى علم", "Port Safaga سفاجا", "Alexandrie الإسكندرية",
    "Jérusalem", "Tel-Aviv", "Amman", "Madaba", "Ma'in", "Al-Karak", "Dana",
    ...
    "Port-Vila", "Papeete", "Bora-Bora", "Honolulu", "Anchorage", "Barrow", "Fairbanks", "Pays de Galles", "York",
    "Seoul", "Incheon", "Pyongyang", "Tokyo", "Osaka",
    "Qamani'tuaq", "Reykjavik","Turku", "Tampere", "Oulu", "Alta", "Selfoss", "Akureyri", "Reyðarfjörður", "Kirkjubæjarklaustur",
    "Flókalundur", "Vík í Mýrdal", "Seyðisfjörður",
    "Longyearbyen", "Barentsburg", "Pyramiden", "Grumantbyen","Ny-Ålesund",
    "Antarctique""Oslo", "Stockholm", "Helsinki", "Rovaniemi", "La Havane", "Nassau", "San Juan",
