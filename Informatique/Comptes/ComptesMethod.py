...
def openfilleComptesMethod():
    def se_connecter(service):
        ...
        mot_de_passe = getpass.getpass("Entrez votre mot de passe pour {}: ".format(service))
    ...
    def menu_principal():
        services = [
            ...
            "Carrefour", "iGreal", "IKEA", "Ouest France", "Instagram", "CGR", "Gaumont", "SNCF", "RATP",
            "Transavia", "Air France", "Emirates", "Delta Air Lines", "American Airlines", "Alaska Airlines",
            "Corsair", "Europcar", "Vivino", "Franceinfo", "Ouest-France", "Le Figaro", "Le Monde",
