def openfilleMeteoMethod():
    ...
    "Épernon", "Houx", "Le Mans", "Bordeaux", "Caen", "Rouen", "Amiens", "Compiègne", "Reims",
    ...
    "Milan", "Venise", "Turin", "Rome", "Palerme", "Catane", "Héraklion", "La Canée", "Le Caire", "Jérusalem",
    "Tel-Aviv", "Amman", "Madaba", "Ma'in", "Al-Karak", "Dana", "Ma'an", "Petra", "Al-'Ula", "Al-Madinah", "Riyad", "Manama",
    "Doha", "Dubaï", "Mascate", "Colombo", "Bangalore","Abidjan", "Accra", "Libreville", "Conakry", "Dakar", "Casablanca",
    "Madrid", "Barcelone", "Bilbao", "Palma", "Lisbonne", "Vigo", "Porto", "Séville", "Cadix", "Gibraltar", "Málaga",
    "Tunis", "Tripoli","Funchal", "Las Palmas de Gran Canaria", "Monterrey", "León", "Managua", "San José", "Bogota", "Quito",
    "Lima", "Trujillo", "Rio de Janeiro", "São Paulo", "Montevideo", "Punta Arenas", "Îles Falkland (Malvinas)",
    "Santiago", "Paramaribo", "Dar es Salam", "Arusha", "Zanzibar", "Luanda", "Freetown", "Niamey", "Djouba",
    ...
    "Hanoï", "Phnom Penh", "Bangkok", "Manille", "Naypyidaw", "Chittagong", "Dacca", "Katmandou",
    "Karachi", "Hyderâbâd"
    ]
