...
lines = {
    ...
    'M3': ['Pont de Levallois - Bécon', 'Anatole France', 'Louise Michel', 'Porte de Champerret', 'Pereire', 'Wagram',
    ...
    'M8': ['Balard', 'Lourmel', 'Boucicaut', 'Félix Faure', 'Commerce', 'La Motte-Picquet - Grenelle',
           'École Militaire', 'La Tour-Maubourg', 'Invalides', 'Concorde', 'Madeleine', 'Opéra', 'Richelieu - Drouot',
    ...
    'M10': ['Boulogne - Pont de Saint-Cloud', 'Boulogne - Jean Jaurès', 'Michel-Ange - Molitor', 'Chardon-Lagache',
            'Mirabeau', 'Javel - André Citroën', 'Charles Michels', 'Avenue Émile Zola', 'La Motte-Picquet - Grenelle',
    ...
    'M13': ['Châtillon - Montrouge', 'Malakoff - Plateau de Vanves', 'Malakoff - Rue Étienne Dolet', 'Porte de Vanves',
    ...
    'RER B': ['Aéroport Charles de Gaulle 2 - TGV', 'Aéroport Charles de Gaulle 1', 'Parc des Expositions',
              'Villepinte', 'Sevran - Beaudottes', 'Sevran - Livry', 'Aulnay-sous-Bois', 'Le Blanc-Mesnil', 'Drancy',
              ...
              'Gentilly', 'Laplace', 'Arcueil - Cachan', 'Bagneux', 'Bourg-la-Reine', 'Sceaux', 'Fontenay-aux-Roses',
    ...
    'RER C': ['Pontoise', 'Saint-Ouen-l\'Aumône - Liesse', 'Saint-Ouen-l\'Aumône', 'Éragny - Neuville',
              ...
              'Bougival', 'Louveciennes', 'Marly-le-Roi', 'L\'Étang-la-Ville', 'Saint-Nom-la-Bretèche - Forêt de Marly',
              'Saint-Germain-en-Laye'],
    'T1': ['Saint-Denis - Basilique', 'Gare de Saint-Denis', 'Marché de Saint-Denis', 'La Courneuve - Aubervilliers',
           ...
           'Les Fêtes', 'Bobigny - Pantin - Raymond Queneau', 'Gaston Roulaud', 'Maryse Bastié', 'La Remise à Jorelle',
    ...
    'T2': ['Pont de Bezons', 'Les Fauvelles', 'Jacqueline Auriol', 'Parc Pierre Lagravère', 'Les Grésillons',
           'Les Agnettes', 'Gabriel Péri', 'Asnières - Gennevilliers - Les Courtilles', 'Les Courtilles', 'Les Côteaux',
           'Les Milons', 'Puteaux', 'Belvédère', 'Issy - Val de Seine', 'Jacques Henri Lartigue', 'Les Moulineaux',
           'Parc de Saint-Cloud'],
'T3A': ['Pont du Garigliano', 'Desnouettes', 'Balard', 'Lourmel', 'Georges Brassens - Parc de la Porte de Vanves', 'Didot', 'Porte de Vanves', 'Jean Moulin', 'Porte d\'Orléans', 'Montsouris', 'Cité Universitaire', 'Stade Charléty', 'Poterne des Peupliers', 'Porte de Gentilly', 'Hôpital de la Croix Saint-Simon', 'Porte d\'Ivry', 'Maryse Bastié', 'Porte de Choisy', 'Porte de Vitry', 'Villejuif - Léo Lagrange', 'Villejuif - Paul Vaillant-Couturier', 'Villejuif - Louis Aragon', 'Porte d\'Italie'],
'T3B': ['Porte de Vincennes', 'Porte de Montreuil', 'Marie de Miribel', 'Adrienne Bolland', 'Porte de Bagnolet', 'Alexandra David-Néel', 'Place des Fêtes', 'Buttes Chaumont', 'Rosa Parks', 'Porte de Pantin', 'Porte de la Villette', 'Porte d\'Aubervilliers'],
}
